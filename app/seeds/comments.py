...
def seed_comments():
    ...
    comment8 = Comment(user_id=9, post_id=13, description="I'm going next year dude! You going?", createdAt=datetime.now())
    comment9 = Comment(user_id=14, post_id=13, description="Revan! Heck yes!", createdAt=datetime.now())
    ...
    comment16 = Comment(user_id=10, post_id=25, description="Nerd", createdAt=datetime.now())
    comment17 = Comment(user_id=13, post_id=25, description="What Ann said", createdAt=datetime.now())
    comment18 = Comment(user_id=14, post_id=25, description="What they both said", createdAt=datetime.now())
    comment19 = Comment(user_id=3, post_id=25, description="I think it looks clean", createdAt=datetime.now())
    comment20 = Comment(user_id=9, post_id=25, description="Thanks Neb!", createdAt=datetime.now())
    comment21 = Comment(user_id=3, post_id=25, description="Just kidding you nerd", createdAt=datetime.now())
    comment22 = Comment(user_id=13, post_id=29, description="Perfect picture of you. Just the back", createdAt=datetime.now())
    comment23 = Comment(user_id=14, post_id=29, description="What set was this?", createdAt=datetime.now())
    comment24 = Comment(user_id=9, post_id=29, description="@David - Lost Frequencies! They were so mellow for my taste though", createdAt=datetime.now())
    ...
    comment29 = Comment(user_id=9, post_id=27, description="My name Jeff", createdAt=datetime.now())
    comment30 = Comment(user_id=4, post_id=27, description="Brandon", createdAt=datetime.now())
    comment31 = Comment(user_id=10, post_id=27, description="Ann", createdAt=datetime.now())
    comment32 = Comment(user_id=3, post_id=27, description="Your Name is the anime's name", createdAt=datetime.now())
    comment33 = Comment(user_id=13, post_id=27, description="Andrew", createdAt=datetime.now())
    comment34 = Comment(user_id=14, post_id=27, description="David", createdAt=datetime.now())
    comment35 = Comment(user_id=3, post_id=27, description="Seriously?", createdAt=datetime.now())
    comment36 = Comment(user_id=10, post_id=17, description="This does rock!", createdAt=datetime.now())
    comment37 = Comment(user_id=9, post_id=26, description="Same dude", createdAt=datetime.now())
    ...
    comment47 = Comment(user_id=9, post_id=12, description="Did he bring his own piano to the park?", createdAt=datetime.now())
    comment48 = Comment(user_id=9, post_id=18, description="Release a new GTA soon?", createdAt=datetime.now())
    comment49 = Comment(user_id=9, post_id=16, description="I have a girlfriend and you are married... Chill", createdAt=datetime.now())
    ...
    comment53 = Comment(user_id=4, post_id=7, description="I live so close to you!", createdAt=datetime.now())
