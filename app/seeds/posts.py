...
def seed_posts():
    ...
    post7 = Post(user_id=13, media_url='https://i.imgur.com/qU3Wimo.jpg', description='Love my city', createdAt=datetime.now())
    ...
    post18 = Post(user_id=11, media_url='https://i.imgur.com/9sxGzGX.jpg', description="This game is old but we're still making money off of this so no GTA 6 for you...", createdAt=datetime.now())
    ...
    post25 = Post(user_id=9, media_url='https://i.imgur.com/IOYjKXM.jpg?5', description='Was the Green Ranger for Halloween a while back', createdAt=datetime.now())
    post26 = Post(user_id=4, media_url='https://i.imgur.com/uWVZvE9.jpg?1', description='Love me some Genshin Impact', createdAt=datetime.now())
    post27 = Post(user_id=3, media_url='https://i.imgur.com/9peZDQD.jpg', description='My favorite anime - Your Name', createdAt=datetime.now())
    ...
    post29 = Post(user_id=9, media_url='https://i.imgur.com/CDA2VwN.jpg', description='Got my picture taken by Insomniac during EDC. They said I hold my flag well.', createdAt=datetime.now())
